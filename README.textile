...
p. To override the default settings globally, use the @settings@ method:

bc.. $().settings({showLegend: false});

p. When called without parameters, the @settings@ method returns the current default settings hash.
...
* Line charts and area charts are missing...
